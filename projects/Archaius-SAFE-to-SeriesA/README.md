...
#### Live Flying & Testing with 101st Airborne — Ft. Campbell, KY

<table>
<tr>
<td width="50%" valign="top" align="center">

<img src="./assets/ft-campbell-fpv-demo.png" alt="Archaius FPV flight demonstration — Grale C2 operator interface" width="100%" style="border-radius:10px; box-shadow:0 0 24px rgba(255,43,214,0.25);"/>
...
<img src="./assets/abe-drone-grale-c2.png" alt="Attritable Battlefield Enabler (ABE) drone with Grale C2 integration" width="100%" style="border-radius:10px; box-shadow:0 0 24px rgba(255,43,214,0.25);"/>
...
- **Systems bring-up under real time constraints** I was handed the drone directly by US Army personell as I arrived on base. Under tight time constraints in a forward deployed workshop, I worked through several software & hardware integration issues in order to be ready for the demo. 
- **Flew the demo** Piloted and demonstrated Grale C2 capabilities live for the unit on US Army drone. Using knowledge about our subsystems capabilities allowed me to successfully show all that our product was capable of in an easily digestible and impactful demonstration. 
...
### Built out a series of drones with a drone partner for live demonstrations in Ukraine

<div align="center">

<img src="./assets/grale-c2-integrated-drone.png" alt="Grale C2 module integrated onto a partner drone airframe" width="55%" style="border-radius:10px; box-shadow:0 0 24px rgba(255,43,214,0.25);"/>

<sub><em>Grale C2 integrated onto a partner airframe for live demos with forward-deployed Ukrainian teams.</em></sub>
...
- **Did a full dataroom gap analysis and provided recommendations to C-suite** Based on my prior Venture Capital experience, I went through Archaius' existing dataroom and conducted a gap analysis. I was able to pinpoint a few weak spots and preemtively make improvements such that VCs will have their diligence questions answered in a satisfactory manner.

- **Participated in calls with VCs, both technical and nontechnical** My VC experience also made me a valuable asset in Series A meeting with outside venture firms. Given that I have an intuitive understanding of what VCs are looking for, I was able to present Archaius' case effectively. 
