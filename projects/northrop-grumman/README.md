...
<img src="./assets/aerial-refueling-fuel-subsystem.png" alt="Aerial refueling of a Northrop Grumman stealth bomber — fuel subsystem under operational load" width="90%" style="border-radius:10px; box-shadow:0 0 24px rgba(255,43,214,0.25);"/>

<sub><em>Aerial refueling under way — the fuel subsystem operating at real mission stakes.</em></sub>
